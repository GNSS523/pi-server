    ...
    return new Promise(function (resolve, reject) {
      ...
      user.save(function (err, theuser) {
        if (err) {
          ...
          console.log( chalk.red('saveUser   -- Failed to add local ')+ err);
...
function seedTheUser (user) {
  return function (password) {
    return new Promise(function (resolve, reject) {
      ...
      console.log('seed.js-------------',user);
      console.log('seed.js-------------',user.username , seedOptions.seedAdmin.username);
...
module.exports.start = function start(options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    console.log(seedOptions.seedUser);
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      console.log( chalk.green( 'add both user and admin account ') );
      User.generateRandomPassphrase()
